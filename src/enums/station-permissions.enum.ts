export enum StationPermissions {
  ...
  View_Station_Page = "view station management",
  ...
  Manage_Station_Mount_Points = "manage station mounts",
  Manage_Station_Remote_Relays = "manage station remotes",
  Manage_Station_Media = "manage station media",
  Manage_Station_Automation = "manage station automation",
  Manage_Station_Web_Hooks = "manage station web hooks",
